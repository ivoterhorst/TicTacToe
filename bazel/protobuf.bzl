...
def well_known_proto_libs():
    ...
    return ["@protobuf//:" + b for b in _WELL_KNOWN_PROTOS_BASE]
...
def is_well_known(label):
    ...
    all_wkt_targets = (["@protobuf//:" + b for b in _WELL_KNOWN_PROTOS_BASE] +
                       ["@protobuf//:protobuf" + b for b in _WELL_KNOWN_PROTOS_BASE])
